// penerapan final pada class album
public final class Album extends Produk implements Search {
    ...
    public void SearchAlbum(String albumName) {
        if (getNama_produk().toLowerCase().contains(albumName.toLowerCase())) {
    ...
    @Override
    public void SearchInstrument(String instrumentName){
