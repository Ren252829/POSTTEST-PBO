public class Instrument extends Produk implements Search {
    ...
    @Override
    public void SearchInstrument(String instrumentmName) {
        if (getNama_produk().toLowerCase().contains(instrumentmName.toLowerCase())) {
